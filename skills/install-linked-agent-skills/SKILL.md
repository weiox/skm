...
```bash
bash ~/.dotfiles/.config/agent-hub/skills/vendor/skill-init/skills/install-linked-agent-skills/scripts/install-linked-skill.sh "<link>" [vendor-name]
```

Examples:

```bash
bash ~/.dotfiles/.config/agent-hub/skills/vendor/skill-init/skills/install-linked-agent-skills/scripts/install-linked-skill.sh \
